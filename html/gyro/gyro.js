...
function on_motion_uab(e)
{
  ...
  document.getElementById("id_beta_acc").innerHTML = -Math.rand(Math.atan(acc.x/acc.z) / Math.PI * 180 * 100)/100 ;
  document.getElementById("id_gamma_acc").innerHTML = Math.rand(Math.atan(acc.y/acc.z) / Math.PI * 180 * 100)/100;
