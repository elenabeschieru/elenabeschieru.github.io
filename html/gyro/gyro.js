...
function on_motion_uab(e)
{
  ...
  document.getElemantById("id_beta_acc").innerHTML = Math.rand(Math.atan(acc.x/acc.z) / Math.PI * 180 * 100)/100 ;
  document.getElemantById("id_gamma_acc").innerHTML = Math.rand(Math.atan(acc.y/acc.z) / Math.PI * 180 * 100)/100;
