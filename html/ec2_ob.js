...
function  t_ec2() {
      ...
      {
        document.getElementById("id_x1").innerHTML = " x1 = "+ this.x1_re + " x1_im" + this.x1_im + "i";
        document.getElementById("id_x2").innerHTML = " x2 = "+ this.x2_re + " x1_im" + this.x2_im + "i";
      }
}
